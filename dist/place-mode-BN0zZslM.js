...
function U(e, t, n) {
	return e.get("draft") === "1" || t === "edit" ? !!M(n) : !1;
}
function W(e = V()) {
	return H(e) !== "edit" || e.get("draft") !== "1" ? !1 : !!M(m(f()))?.steps?.length;
}
function G() {
	let e = V(), t = f();
	if (z = H(e), document.documentElement.dataset.mode = z, !t) return;
	let n = m(t);
	if (document.documentElement.dataset.placeId = n, B = U(e, z, n), B) {
		let r = M(n);
		r && k(t, r, { includeRoute: z !== "edit" || W(e) }), z === "view" && e.get("draft") === "1" && (document.documentElement.dataset.draftPreview = "true");
	} else if (z === "view") {
		let e = P(n);
		e && k(t, e);
	}
...
function q() {
	let e = V();
	return e.get("draft") === "1" && e.get("fresh") === "1";
}
function J({ mode: e = "view", draft: t = !1, fresh: n = !1, published: r = !1 } = {}) {
...
function X() {
	return V().get("published") === "1";
}
async function Z() {
	if (K() !== "edit") return;
	if (W()) {
		let { initPlaceRouteEditUi: e } = await import("./place-route-reorder-CjImlt8x.js");
		e();
		return;
	}
	let { initPlaceEditorUi: e } = await import("./place-editor-C_rPAi5H.js");
	e();
}
async function Q() {
	if (K() !== "view") return;
	let { initPlaceViewUi: e } = await import("./place-view-3FQMhGMs.js");
	if (e(), X()) {
		Y();
...
//#endregion
export { R as a, m as c, v as d, N as f, l as h, q as i, M as l, c as m, Z as n, p as o, S as p, Q as r, f as s, J as t, I as u };
